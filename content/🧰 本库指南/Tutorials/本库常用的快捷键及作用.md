---
{"publish":true,"permalink":"/🧰 本库指南/Tutorials/本库常用的快捷键及作用.md","title":"本库常用的快捷键及作用","created":"2022-07-03","modified":"2023-03-14","published":"2025-07-07T16:50:55.643+08:00","cssclasses":""}
---
...
- 若是高频使用的文本编辑，则可以考虑自定义并记忆快捷键，建议自己常用的其他文本编辑器统一快捷键，如[[🧰 本库指南/Obsidian/教程/vscode代码编辑和obsidian文本编辑快捷键 - 触发快捷键]]，随便举几个例子
	- cmd + b，加粗
	- cmd + a，全选
	- cmd + l, 切换为任务项
	- cmd + e，编辑模式/阅读模式切换
