---
{"publish":true,"permalink":"/🧰 本库指南/Tutorials/» 本库笔记的emoji符号记录.md","title":"» 本库笔记的emoji符号记录","created":"2022-08-05","modified":"2023-03-14","published":"2025-07-07T17:10:23.959+08:00","tags":["本库教程"],"cssclasses":""}
---
...
当然也可以通过标签tag+ [[🧰 本库指南/Obsidian/Plugins/Supercharged Links]]插件实现同样的效果，但无法通过搜索文件名直接搜索到，引用起来不方便。

不用追求分类的完备完整收录，重要的是养成这个习惯即可，在建立新词条的时候，能有意识地用emoji符号区分开。

## 特殊项

[[🧰 本库指南/Tutorials/macos系统中快捷输入各种特殊符号]]
...
## 用[[🧰 本库指南/Obsidian/Plugins/Supercharged Links]]自动生成的emoji前缀，与标题之间加空格
